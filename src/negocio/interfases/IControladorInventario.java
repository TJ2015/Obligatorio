...
public interface IControladorInventario {
	...
	public DataProducto crearProducto(String nombre, String descripcion, double precio, String categoria, String atributosList, long idAV, int stock, UploadedFile file) throws Exception;
