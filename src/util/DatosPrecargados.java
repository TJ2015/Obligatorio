	...
	void atStartup() {
		...
		if (!cUsu.existeUsuarioNick("1")) {
			...
			try {
				...
				cInv.crearProducto("Leche", "1 Litro de leche ultra pasteurizada.", 15, "Lacteos", "Marca:Conaprole;",
						idHeladera, 2, null);
				cInv.crearProducto("Yogurt", "1 Litro de Yogurt de Frutilla", 20, "Lacteos",
						"Marca:Parmalat;Sabor:Frutilla;", idHeladera, 1, null);
				cInv.crearProducto("Lechuga", "Una cabeza de lechuga.", 10, "Verduras", "Color:Verde;", idHeladera, 2,
						null);
